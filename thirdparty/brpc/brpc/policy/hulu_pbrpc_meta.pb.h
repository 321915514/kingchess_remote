...
class HuluRpcRequestMeta final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR HuluRpcRequestMeta(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  HuluRpcRequestMeta* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
class HuluRpcResponseMeta final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR HuluRpcResponseMeta(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  HuluRpcResponseMeta* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
inline void HuluRpcRequestMeta::unsafe_arena_set_allocated_chuck_info(
  ...
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.chuck_info_);
  }
  _impl_.chuck_info_ = chuck_info;
  if (chuck_info) {
...
void HuluRpcRequestMeta::set_credential_data(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000008u;
 _impl_.credential_data_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void HuluRpcRequestMeta::_internal_set_credential_data(const std::string& value) {
  _impl_._has_bits_[0] |= 0x00000008u;
  _impl_.credential_data_.Set(value, GetArenaForAllocation());
}
inline std::string* HuluRpcRequestMeta::_internal_mutable_credential_data() {
  _impl_._has_bits_[0] |= 0x00000008u;
  return _impl_.credential_data_.Mutable(GetArenaForAllocation());
}
inline std::string* HuluRpcRequestMeta::release_credential_data() {
  ...
  _impl_._has_bits_[0] &= ~0x00000008u;
  auto* p = _impl_.credential_data_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline void HuluRpcRequestMeta::set_allocated_credential_data(std::string* credential_data) {
  ...
  _impl_.credential_data_.SetAllocated(credential_data, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.credential_data_.IsDefault()) {
    _impl_.credential_data_.Set("", GetArenaForAllocation());
  }
