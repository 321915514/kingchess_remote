...
from net.policy_value_net_pytorch_9 import PolicyValueNet  # Pytorch
import os
import uuid


from decode_proto_file_9 import DecodeDataset
import logging
from transfer_trt_9 import export_engine
...
class TrainPipeline():
    def __init__(self, init_model=None):
        ...
        self.data_parse = DecodeDataset('/root/autodl-tmp/dataset_cpp')
    ...
    def policy_evaluate(self, n_games=100):
        ...
        #     winner = self.start_play_black_is_mcts(random)
        #     if winner == Player.black:
        #         win_black_random += 1
        # for i in range(n_games):
        #     winner = self.start_play_white_is_mcts(random)
        #     if winner == Player.white:
        #         win_white_random += 1
            ...
            while True:
                ...
                #                          CONFIG['pytorch_current_engine_path'])
                    ...
                    if (self.iters+ 1) % 2000 == 0:
                        ...
                        folder_path = "/root/autodl-tmp/dataset_cpp"
...
if __name__ == '__main__':
    ...
    # s = time.time()
    training_pipeline = TrainPipeline("./model/10000.pth")
