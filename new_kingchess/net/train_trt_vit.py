...
from net.policy_value_net_vit import PolicyValueNet  # Pytorch
import os
import uuid
    ...
    def __init__(self, init_model=None):
        ...
        if init_model:
            try:
                ...
                self.policy_value_net = PolicyValueNet(model_file=CONFIG_LDCONV['pytorch_model_path'], device='cuda')
...
#                win_white_expert += 1
        ...
        logger.info("num_playouts:{}, black win: {}, white win: {}, n_games : {}".format(2,
            ...
            while True:
                ...
                #                          CONFIG['pytorch_current_engine_path'])
                    ...
                    if (self.iters+ 1) % 2000 == 0:
                        ...
                        self.policy_value_net.save_model(f'./ldconv_model/{self.iters+1}.pth')

                        if os.path.exists(CONFIG_LDCONV['pytorch_current_model_path']):
                            export_engine(CONFIG_LDCONV['pytorch_current_model_path'], CONFIG_LDCONV['pytorch_current_onnx_path'],
                                          CONFIG_LDCONV['pytorch_current_engine_path'])
...
if __name__ == '__main__':
    ...
    # s = time.time()
    training_pipeline = TrainPipeline("./ldconv_model/current.pth")
