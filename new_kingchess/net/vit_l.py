...
class ViT(nn.Module):
    def __init__(self):
        super().__init__()
        # Larger embedding dimension and more heads
        in_channels = 32
        patch_size = 4
        embed_dim = 256  # Increased from 128
        num_heads = 8    # Increased from 4
        num_encoders = 8 # Increased from 4
        mlp_ratio = 6.0  # Increased from 4.0
        drop_rate = 0.1
        drop_path_rate = 0.2  # Slightly increased drop path rate
